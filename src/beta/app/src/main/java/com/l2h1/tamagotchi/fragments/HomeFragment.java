...
import com.l2h1.tamagotchi.activities.FriendsActivity;
...
public class HomeFragment extends Fragment implements SensorEventListener {
    ...
    private void initProgressBars() {
        ...
        sociabilityImageView.setOnClickListener(v -> {
    ...
    public void onSensorChanged(SensorEvent event) {
        ...
        if (event.sensor.getType() == Sensor.TYPE_ACCELEROMETER && resident != null) {
            ...
            float z_acc1 = event.values[2];

            //Log.v("value", x_acc1 + "/" + y_acc1 + "/" + z_acc1);
